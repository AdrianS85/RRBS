...
parallel --verbose --link --joblog jolog.txt --tmpdir /tmp/ --jobs 5  "python /nudup-master/nudup.py --rmdup-only  -T /tmp/tmp/ --paired-end -f {1} -o {2.} {2}" :::: pairs &> nudup_raport.txt
